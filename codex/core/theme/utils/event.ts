/**
 * @see https://raw.githubusercontent.com/quasarframework/quasar/dev/src/utils/event.js
...
export interface MouseWheelDistance {
    spinX: number
    spinY: number
    pixelX: number
    pixelY: number
...
export function getMouseWheelDistance(e): MouseWheelDistance {
