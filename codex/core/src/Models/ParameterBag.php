...
class ParameterBag extends \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag
{
    ...
    /**
     * @return \Codex\Contracts\Models\Model
     */
    public function getModel(): \Codex\Contracts\Models\Model
    {
        return $this->model;
    }

    /**
     * @param \Codex\Contracts\Models\Model $model
     */
    public function setModel(\Codex\Contracts\Models\Model $model): void
    {
        $this->model = $model;
    }
