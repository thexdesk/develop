...
class PhpdocMacros
{
     ...
     * @return string
     */
    public function methodSignature($isCloser = false, $query, $inline = false, $hide = '')
    {
        $hide = $this->transformHideCsv($hide);
        $props = $this->toJson(compact('query', 'inline', 'hide'));
     ...
     * @return string
     */
    public function method($isCloser = false, $query, $collapse = false, $closed = false, $hide = '')
    {
        $hide = $this->transformHideCsv($hide);
        $props = json_encode(compact('query', 'collapse', 'closed', 'hide'));
