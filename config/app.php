...
//        'maxDepth' => 3,
//    ]);
//    die($dumper->dump($cloner->cloneVar($var)));
//}
//
//_dd([
//    'ip'             => $request->ip(),
...
//    ],
//    'ini'            => collect(ini_get_all('xdebug'))->mapWithKeys(function ($item, $key) {
//        return [ $key => $item[ 'local_value' ] ];
//    }),
//]);

return [
    'debug_blacklist' => $request->isFromTrustedProxy() ? [] : [
        '_COOKIE' => array_diff(
            array_keys($_COOKIE),
