...
namespace PHPSTORM_META {
    ...
    * Generated on 2019-04-06 15:22:53.
    *
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'Codex\Addons\AddonCollection' => \Codex\Addons\AddonCollection::class,
        'Codex\Addons\AddonManager' => \Codex\Addons\AddonManager::class,
        'Codex\Addons\AddonRegistry' => \Codex\Addons\AddonRegistry::class,
        'Codex\Addons\Extensions\ExtensionCollection' => \Codex\Addons\Extensions\ExtensionCollection::class,
        'Codex\Api\GraphQL\GraphQL' => \Codex\Api\GraphQL\GraphQL::class,
        'Codex\Api\GraphQL\QueryDirectiveRegistry' => \Codex\Api\GraphQL\QueryDirectiveRegistry::class,
        'Codex\Attributes\AttributeDefinitionRegistry' => \Codex\Attributes\AttributeDefinitionRegistry::class,
        'Codex\Attributes\ConfigResolverRegistry' => \Codex\Attributes\ConfigResolverRegistry::class,
        'Codex\Blog\Contracts\Blog' => \Codex\Blog\Blog::class,
        'Codex\Codex' => \Codex\Codex::class,
        'Codex\Comments\CommentsManager' => \Codex\Comments\CommentsManager::class,
        'Codex\Phpdoc\Serializer\AttributeAnnotationReader' => \Codex\Phpdoc\Serializer\AttributeAnnotationReader::class,
        ...
        'JMS\Serializer\Serializer' => \JMS\Serializer\Serializer::class,
        ...
        'Nuwave\Lighthouse\GraphQL' => \Codex\Api\GraphQL\GraphQL::class,
        ...
        'Nuwave\Lighthouse\Schema\SchemaBuilder' => \Codex\Api\GraphQL\SchemaBuilder::class,
        ...
        'algolia' => \Vinkla\Algolia\AlgoliaManager::class,
        'algolia.connection' => \AlgoliaSearch\Client::class,
        'algolia.factory' => \Vinkla\Algolia\AlgoliaFactory::class,
        'auth' => \Illuminate\Auth\AuthManager::class,
        'auth.driver' => \Illuminate\Auth\SessionGuard::class,
        'auth.password' => \Illuminate\Auth\Passwords\PasswordBrokerManager::class,
        'auth.password.broker' => \Illuminate\Auth\Passwords\PasswordBroker::class,
        'bitbucket' => \GrahamCampbell\Bitbucket\BitbucketManager::class,
        'bitbucket.authfactory' => \GrahamCampbell\Bitbucket\Authenticators\AuthenticatorFactory::class,
        'bitbucket.factory' => \GrahamCampbell\Bitbucket\BitbucketFactory::class,
        ...
        'codex' => \Codex\Codex::class,
        'codex.addons' => \Codex\Addons\AddonCollection::class,
        'codex.attributes' => \Codex\Attributes\AttributeDefinitionRegistry::class,
        'codex.attributes.config' => \Codex\Attributes\ConfigResolverRegistry::class,
        'codex.blog' => \Codex\Blog\Blog::class,
        'codex.config' => \Codex\Config\Repository::class,
        'codex.config.language' => \Codex\Config\ExpressionLanguage::class,
        'codex.config.processor' => \Codex\Config\ConfigProcessor::class,
        'codex.extensions' => \Codex\Addons\Extensions\ExtensionCollection::class,
        'codex.git.manager' => \Codex\Git\ConnectionManager::class,
        'codex.log' => \Codex\Log\Log::class,
        ...
        'lighthouse-utils' => \DeInternetJongens\LighthouseUtils\LighthouseUtils::class,
